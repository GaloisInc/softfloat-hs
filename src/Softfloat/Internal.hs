...
-- 16-bit operations
foreign import ccall "f16_roundToInt" f16_roundToInt :: Word16 -> Word8 -> Int -> IO Word16
foreign import ccall "f16_add"  f16_add  :: Word16 -> Word16 -> IO Word16
foreign import ccall "f16_sub"  f16_sub  :: Word16 -> Word16 -> IO Word16
foreign import ccall "f16_mul"  f16_mul  :: Word16 -> Word16 -> IO Word16
foreign import ccall "f16_div"  f16_div  :: Word16 -> Word16 -> IO Word16
foreign import ccall "f16_rem"  f16_rem  :: Word16 -> Word16 -> IO Word16
foreign import ccall "f16_sqrt" f16_sqrt :: Word16 -> IO Word16
...
foreign import ccall "f32_roundToInt" f32_roundToInt :: Word32 -> Word8 -> Int -> IO Word32
foreign import ccall "f32_add"  f32_add  :: Word32 -> Word32 -> IO Word32
foreign import ccall "f32_sub"  f32_sub  :: Word32 -> Word32 -> IO Word32
foreign import ccall "f32_mul"  f32_mul  :: Word32 -> Word32 -> IO Word32
foreign import ccall "f32_div"  f32_div  :: Word32 -> Word32 -> IO Word32
foreign import ccall "f32_rem"  f32_rem  :: Word32 -> Word32 -> IO Word32
foreign import ccall "f32_sqrt" f32_sqrt :: Word32 -> IO Word32
foreign import ccall "f32_eq"   f32_eq   :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_le"   f32_le   :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_lt"   f32_lt   :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_eq_signaling" f32_eq_signaling :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_le_quiet"     f32_le_quiet     :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_lt_quiet"     f32_lt_quiet     :: Word32 -> Word32 -> IO Int
foreign import ccall "f32_isSignalingNaN" f32_isSignalingNaN :: Word32 -> IO Int

foreign import ccall "f64_roundToInt" f64_roundToInt :: Word64 -> Word8 -> Int -> IO Word64
foreign import ccall "f64_add"  f64_add  :: Word64 -> Word64 -> IO Word64
foreign import ccall "f64_sub"  f64_sub  :: Word64 -> Word64 -> IO Word64
foreign import ccall "f64_mul"  f64_mul  :: Word64 -> Word64 -> IO Word64
foreign import ccall "f64_div"  f64_div  :: Word64 -> Word64 -> IO Word64
foreign import ccall "f64_rem"  f64_rem  :: Word64 -> Word64 -> IO Word64
foreign import ccall "f64_sqrt" f64_sqrt :: Word64 -> IO Word64
foreign import ccall "f64_eq"   f64_eq   :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_le"   f64_le   :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_lt"   f64_lt   :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_eq_signaling" f64_eq_signaling :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_le_quiet"     f64_le_quiet     :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_lt_quiet"     f64_lt_quiet     :: Word64 -> Word64 -> IO Int
foreign import ccall "f64_isSignalingNaN" f64_isSignalingNaN :: Word64 -> IO Int
