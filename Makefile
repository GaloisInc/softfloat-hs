...
ifeq ($(UNAME), Linux)
SPECIALIZE_TYPE=$(COMPILE_TYPE) SOFTFLOAT_OPTS="-DTHREAD_LOCAL=_Thread_local -DSOFTFLOAT_ROUND_ODD -DINLINE_LEVEL=5 -DSOFTFLOAT_FAST_DIV32TO16 -DSOFTFLOAT_FAST_DIV64TO32 -fpic"
CFLAGS = -shared
